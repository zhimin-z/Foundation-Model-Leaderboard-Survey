...
if __name__ == '__main__':
    ...
    for output_token_length in output_token_length_list_inverse:
        for service_load in service_load_list_inverse:
            ...
            df.to_json(f'{path_leaderboard}/ip-{output_token_length_list_inverse[output_token_length]}-{service_load_list_inverse[service_load]}.json', orient='records', indent=4)
