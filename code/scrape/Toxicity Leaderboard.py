...
path_leaderboard = "data/Toxicity Leaderboard"


def get_json_format_data():
    url = 'https://bias-leaderboard-leaderboard.hf.space'
        ...
        try:
            ...
            while True:
                try:
                    ...
                    try:
                        results_json = {"T": results[0], "Model": results[-1], "Toxicity (lower is better)": results[2], "Truthful QA": results[3], "CrowS-Pairs English": results[4]}
